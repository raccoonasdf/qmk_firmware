 ...
 * `-----------------------------------------------------------------------------------'
 *    ^- LCtrl+RCtrl when tapped (to swap KVM outputs)
 */
[_BASE] = LAYOUT_preonic_grid(
    ...
    MT(MOD_LCTL, LCTL(KC_RCTL)), KC_LGUI, KC_LALT, KC_RALT, LOWER  , KC_SPC , KC_SPC , RAISE  , KC_LEFT, KC_DOWN, KC_UP  , KC_RGHT
),
...
[_ADJUST] = LAYOUT_preonic_grid(
    ...
    _______, XXXXXXX, XXXXXXX, DEBUG  , XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,
